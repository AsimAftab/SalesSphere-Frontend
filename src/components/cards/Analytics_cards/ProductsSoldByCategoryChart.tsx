...
const ProductsSoldByCategoryChart: React.FC<ProductsSoldByCategoryChartProps> = ({
    ...
    const { containerRef, ready } = useChartResize();
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col h-full">
            ...
            {hasData ? (
                ...
                <div className="flex items-center justify-center flex-grow text-gray-500 text-center p-4">
                    No products sold data available for this breakdown.
                </div>
            )}
        </div>
    );
