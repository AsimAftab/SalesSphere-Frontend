...
const EmployeeTrackingCard = ({ employee }: EmployeeTrackingCardProps) => {
  return (
    // 1. Wrap the entire card in the Link component
    <Link
      to={`/employee-tracking/${employee.id}`}
      className="block bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg shadow-md overflow-hidden flex flex-col justify-between transition-all hover:shadow-lg"
    >
      <div>
        {/* Top Info Section */}
      ...
      {/* 2. Change the footer Link to a div */}
      <div
