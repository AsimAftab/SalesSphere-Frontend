    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:col-span-2">
                ...
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Timezone <span className="text-red-500">*</span></span>
                    <div className="relative">
                        <Controller
                            name="timezone"
                            control={control}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:col-span-2">
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Subscription Duration {!isEditMode && <span className="text-red-500">*</span>}</span>
                    <div className="relative">
                        <Controller
                ...
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Subscription Plan <span className="text-red-500">*</span></span>
                    <div className="relative">
                        <DropDown
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:col-span-2">
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Check-In Time <span className="text-red-500">*</span></span>
                    <div className="relative">
                        <Controller
                            name="checkInTime"
                            control={control}
                ...
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Check-Out Time <span className="text-red-500">*</span></span>
                    <div className="relative">
                        <Controller
                            name="checkOutTime"
                            control={control}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:col-span-2">
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Half Day Check-Out Time <span className="text-red-500">*</span></span>
                    <div className="relative">
                        <Controller
                ...
                <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-semibold text-gray-700">Weekly Off Day <span className="text-red-500">*</span></span>
                    <div className="relative">
                        <Controller
                            name="weeklyOff"
                            control={control}
