...
import { type PartyDetails } from '../../api/services/party/partyDetailsService';
...
interface EditPartyModalProps {
    ...
    isOpen: boolean;
    onClose: () => void;
    onSave: (updatedParty: Partial<PartyDetails>) => void;
}

const EditPartyModal: React.FC<EditPartyModalProps> = ({ party, isOpen, onClose, onSave }) => {
    const [formData, setFormData] = useState({
        companyName: party.companyName,
        ownerName: party.ownerName,
        address: party.address,
        latitude: party.latitude || 27.7172,
        longitude: party.longitude || 85.324,
        email: party.email,
        phone: party.phone,
        panVat: party.panVat,
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const updatedParty: Partial<PartyDetails> = {
            ...
            <div className="bg-white rounded-lg max-w-5xl w-full max-h-[90vh] overflow-y-auto" style={{ zIndex: 10000 }}>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-8">
                        ...
                        <input
                            type="text"
                            value={new Date(party.dateCreated).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric'
                            })}
