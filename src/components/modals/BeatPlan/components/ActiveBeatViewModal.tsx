...
const ActiveBeatViewModal: React.FC<ActiveBeatViewModalProps> = ({ isOpen, onClose, plan, isLoading = false }) => {
    ...
    return (
        ...
        >
            ...
            {/* Enhanced Stats Bar */}
            <div className="px-6 py-4 bg-gradient-to-br from-gray-50/50 to-white border-b border-gray-200/80">
                <div className="flex flex-wrap gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-gray-500 font-medium">Beat Date</p>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-gray-500 font-medium">Visit Progress</p>
                            <p className="text-sm font-bold text-gray-900">
            ...
            {/* Scrollable List - Dynamic Height up to 375px */}
