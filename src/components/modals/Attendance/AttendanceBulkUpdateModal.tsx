          ...
          >
            <div className="mb-6">
              ...
              <textarea
                ...
                className={`block w-full rounded-lg border shadow-sm sm:text-sm p-3 focus:outline-none focus:border-secondary transition-colors ${error ? 'border-red-300 focus:border-red-500' : 'border-gray-200'
                  }`}
