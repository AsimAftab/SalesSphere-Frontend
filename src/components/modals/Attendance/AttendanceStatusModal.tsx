...
const CurrentRecordView: React.FC<{
    record: AttendanceRecordDetails | undefined;
    isLoading: boolean;
    isError: boolean;
                    ...
                    >
                        <div className="pt-2">
                            ...
                            <textarea
                                ...
                                className="block w-full rounded-lg border border-gray-300 shadow-sm sm:text-sm p-3 focus:outline-none focus:border-secondary resize-y transition-colors disabled:bg-gray-50 disabled:text-gray-400"
                            />
                        </div>
...
const AttendanceStatusModal: React.FC<AttendanceStatusModalProps> = ({
    ...
    // Data Query
    const { data: recordData, isLoading: isDataLoading, isError } = useQuery({
