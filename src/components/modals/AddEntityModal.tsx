...
const AddEntityModal: React.FC<AddEntityModalProps> = ({
    ...
    const resetCurrentInterestEntry = () => {
        ...
        setErrors(prev => {
            ...
            delete newErr.newCategory;
            delete newErr.brands;
            delete newErr.technicianName;
            delete newErr.technicianPhone;
            return newErr;
        });
    };
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            setAvailableBrands(existingBrands);
            handleClose(false); 
        }
    ...
    const handleCategorySelect = (e: React.ChangeEvent<HTMLSelectElement>) => {
        setCatSelectValue(e.target.value);
...
                        </div>
                    ...
                    {/* Added pb-32 to allow dropdowns to open downwards if near bottom */}
                    {showInterestSection && (
                                ...
                                <div className="space-y-6 pt-2">
                                    ...
                                    <div className="bg-white p-4 rounded-lg border border-blue-200 shadow-sm">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            {/* Brand Multi-Select - Dropdown Column */}
                                            <div className="md:col-span-2">
                                            ...
                                            {/* Brand Input - Input Column (Always on new line when adding) */}
                                            {isAddingNewBrand && (
                                                <div className="md:col-span-2">
                                                    <label className="text-xs font-semibold text-gray-500 uppercase mb-1">
