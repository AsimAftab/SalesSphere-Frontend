            ...
            <div className="p-6 space-y-6 flex-1 overflow-y-auto">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-secondary focus:border-secondary transition-all"
                    />
                </div>
                ...
                <div className="space-y-4 flex-1 flex flex-col min-h-0">
                    ...
                    {/* List */}
                    <div className="border border-gray-200 rounded-xl overflow-hidden flex-1 min-h-[300px] bg-gray-50/30 relative">
                        {loading ? (
                            ...
                            <div className="overflow-y-auto h-full max-h-[400px] divide-y divide-gray-100">
                                {directories.map((item) => {
                                    ...
                                    const getThemeColor = (type: string) => {
                                        switch (type) {
                                            ...
                                            case 'prospect': return { bg: 'bg-purple-50', text: 'text-purple-600', badgeBg: 'bg-purple-100', badgeText: 'text-purple-700' };
