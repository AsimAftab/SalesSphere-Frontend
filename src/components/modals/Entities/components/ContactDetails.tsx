  ...
  return (
    <div className="md:col-span-2 pt-4 border-t border-dashed border-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Phone */}
        <div>
          <label htmlFor="entityPhone" className="block text-sm font-semibold text-gray-700 mb-2">
        ...
        {/* Email */}
        <div>
          <label htmlFor="entityEmail" className="block text-sm font-semibold text-gray-700 mb-2">Email Address</label>
          <div className="relative">
