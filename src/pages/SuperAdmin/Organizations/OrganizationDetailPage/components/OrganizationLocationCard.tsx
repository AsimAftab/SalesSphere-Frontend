            ...
            <div className="p-4 sm:p-6 pb-0">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-xl sm:text-2xl font-bold text-slate-800 tracking-tight leading-none">Location</h3>
                        </div>
                    </div>
                    {googleMapsUrl && (
                        <Button
                            size="default"
                            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white shadow-sm h-9 px-4"
                ...
                <div className="h-px bg-gray-300 -mx-4 sm:-mx-6 my-3" />
            </div>
            <div className="p-4 sm:p-6 pt-0 flex-1 flex flex-col space-y-5">
                {/* Map or Empty State */}
