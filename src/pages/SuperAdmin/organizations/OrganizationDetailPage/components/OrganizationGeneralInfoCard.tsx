...
import { Building2, User, Phone, Clock, Globe, Calendar, Mail, Zap, IdCard, type LucideIcon } from 'lucide-react';
...
const DisplayValue = ({ label, icon: Icon, value, className = "" }: { label: string, icon: LucideIcon, value?: string | number | null, className?: string }) => (
    <div>
