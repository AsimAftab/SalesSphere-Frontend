...
// Header Skeleton
export const SystemUserHeaderSkeleton = () => {
    return (
        <div className="w-full flex flex-col gap-0 mb-8 px-1">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-4 w-full lg:w-auto lg:flex-1 lg:justify-end">
                    ...
                    {/* Add Button Skeleton */}
                    <Skeleton className="h-10 w-full sm:w-24 rounded-lg shrink-0" />
                </div>
            </div>
        </div>
    );
...
export const SystemUserCardSkeleton = () => {
    return (
...
export const SystemUserListSkeleton = () => {
    return (
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-6">
            {Array.from({ length: ITEMS_PER_PAGE }).map((_, i) => (
                <SystemUserCardSkeleton key={i} />
            ))}
        </div>
    );
};
...
export const SystemUsersSkeleton = () => {
    return (
        <div className="space-y-6">
            <SystemUserHeaderSkeleton />
            <SystemUserListSkeleton />
        </div>
    );
};
