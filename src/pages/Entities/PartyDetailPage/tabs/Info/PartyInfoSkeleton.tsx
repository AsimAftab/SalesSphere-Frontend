                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-8">
                        {[...Array(6)].map((_, i) => (
                            <div key={i} className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="w-32 h-4 bg-gray-200 rounded animate-pulse mt-1" />
                                </div>
                            </div>
                        ))}
                        {/* Full Address */}
                        <div className="md:col-span-2 flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <div className="w-20 h-3 bg-gray-100 rounded animate-pulse" />
                                <div className="w-2/3 h-4 bg-gray-200 rounded animate-pulse mt-1" />
                            </div>
                        </div>
                        {[...Array(2)].map((_, i) => (
                            <div key={`coord-${i}`} className="flex items-start gap-3">
                                <div className="w-9 h-9 bg-gray-200 rounded-lg animate-pulse shrink-0" />
                                <div className="flex-1">
                                    <div className="w-20 h-3 bg-gray-100 rounded animate-pulse" />
                                    <div className="w-32 h-4 bg-gray-200 rounded animate-pulse mt-1" />
            ...
            <div className="lg:col-span-1 flex flex-col gap-6 h-full">
                <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden flex flex-col flex-1 h-full">
                    ...
                    <div className="px-6 pb-6 flex-1 flex flex-col space-y-6">
                        {/* Map placeholder */}
                        <div className="flex-1 min-h-[480px] bg-gray-200 rounded-xl animate-pulse" />
