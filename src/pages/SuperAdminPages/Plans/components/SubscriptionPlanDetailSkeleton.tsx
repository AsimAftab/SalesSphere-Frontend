 ...
 * - 5-column responsive grid (3:2) for main content
 * - Modules card with special gradient header and pagination
 * - Custom module row layout with checkmark indicators
 * - Description section with border separator
 */
