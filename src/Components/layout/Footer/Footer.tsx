      ...
      <div className="px-6 pb-8 pt-16 sm:pt-24 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <div>
              <h3 className="text-sm font-semibold leading-6 text-white">Download Our App</h3>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 md:grid-cols-4 xl:col-span-2 xl:mt-0 xl:pt-[5.5rem]">
            ...
            <div>
              <h3 className="text-sm font-semibold leading-6 text-white">Ready to Boost Your Team's Performance?</h3>
              <div className="mt-6">
        ...
        <div className="grid grid-cols-1 gap-8 items-center xl:grid-cols-3">
          {/* Text content takes the first column */}
           <div className="xl:col-start-2">
            ...
            <p className="text-sm leading-6 text-white">Get the latest updates and insights delivered to your inbox.</p>
          </div>
          ...
          <form className="flex w-full max-w-md items-start gap-x-4">
            <input
              type="email"
              required
              className="min-w-0 flex-auto rounded-lg border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-blue-500 text-sm leading-6"
          ...
          <div className="mt-10 border-t border-secondary pt-10 md:flex md:items-center md:justify-between">
            <div className="flex space-x-16 md:order-1">
            ...
            <p className="mt-8 text-sm leading-6 text-white  md:order-2 md:mt-0">&copy; 2025 SalesSphere. All Rights Reserved.</p>
          </div>
