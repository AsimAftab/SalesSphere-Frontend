      ...
      <div className="px-6 pb-8 pt-16 sm:pt-24 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <div>
              ...
              <div className="mt-10 flex flex-col items-start space-y-4">
                <a href="#"><img className="h-12" src={googlePlayBadge} alt="Get it on Google Play" /></a>
                <a href="#"><img className="h-12" src={appStoreBadge} alt="Download on the App Store" /></a>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 md:grid-cols-4 xl:col-span-2 xl:mt-0 xl:pt-[5.5rem]">
            <div>
              <h3 className="text-lg font-semibold leading-7 text-white">Product</h3>
              <ul role="list" className="mt-6 space-y-4">
                {footerNavigation.product.map((item) => (
                  <li key={item.name}><a href={item.href} className="text-base leading-7 text-white hover:text-secondary">{item.name}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold leading-7 text-white">Resources</h3>
              <ul role="list" className="mt-6 space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold leading-7 text-white">Company</h3>
              <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="grid grid-cols-1 gap-8 items-center xl:grid-cols-3">
          {/* Text content takes the first column */}
           <div className="xl:col-start-2">
            <h3 className="text-lg font-semibold leading-7">Subscribe to our newsletter</h3>
            <p className="text-base leading-7 text-white">Get the latest updates and insights delivered to your inbox.</p>
          </div>
          ...
          <form className="flex w-full max-w-md items-start gap-x-4">
            <input
              type="email"
              required
              className="min-w-0 flex-auto rounded-lg border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-blue-500 text-base leading-7 text-center"
          ...
          <div className="mt-10 border-t border-secondary pt-10 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-sm leading-7 text-white  md:order-2 md:mt-0">&copy; 2025 SalesSphere. All Rights Reserved.</p>
          </div>
