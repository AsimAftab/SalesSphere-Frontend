    ...
    <SkeletonTheme baseColor="#e2e8f0" highlightColor="#f1f5f9">
      <div className="flex-1 flex flex-col h-full overflow-hidden px-1 md:px-0">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-6 flex-shrink-0 px-1">
          ...
          <div className="flex flex-row flex-wrap items-center justify-start lg:justify-end gap-4 w-full lg:w-auto">
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              {/* Export Actions (Conditional) */}
              {canExport && <Skeleton width={85} height={42} borderRadius={8} />}
            </div>

            {/* Bulk Upload (Conditional) */}
            {canImport && <Skeleton height={40} width={130} borderRadius={8} />}

            {/* Add Party Button (Conditional) */}
            {canCreate && <Skeleton height={40} width={160} borderRadius={8} />}
          </div>
        </div>
