...
const OrderListSkeleton: React.FC<OrderListSkeletonProps> = ({
    ...
    <div className="flex-1 flex flex-col">
        ...
        {/* Desktop Table - Matches OrderListTable with actual <table> structure */}
            ...
            <table className="w-full border-collapse">
                ...
                <thead className="text-sm">
                    <tr>
                        ...
                        <th className="px-5 py-3 text-left"><Skeleton width={90} height={14} /></th>
                        <th className="px-5 py-3 text-left"><Skeleton width={85} height={14} /></th>
                ...
                <tbody className="divide-y divide-gray-100">
                    {[...Array(10)].map((_, i) => (
                        <tr key={i} className="hover:bg-gray-50">
                            <td className="px-5 py-3"><Skeleton width={25} height={16} /></td>
                            <td className="px-5 py-3"><Skeleton width={100} height={16} /></td>
                            <td className="px-5 py-3"><Skeleton width={120} height={16} /></td>
                            <td className="px-5 py-3"><Skeleton width={80} height={16} /></td>
                            <td className="px-5 py-3"><Skeleton width={90} height={16} /></td>
                            <td className="px-5 py-3"><Skeleton width={75} height={16} /></td>
                            <td className="px-5 py-4"><Skeleton width={80} height={16} /></td>
                            <td className="px-5 py-4"><Skeleton width={85} height={24} borderRadius={12} /></td>
                        </tr>
                    ))}
                </tbody>
            </table>
