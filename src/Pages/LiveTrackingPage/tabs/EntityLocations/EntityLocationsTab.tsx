...
const EntityLocationsTab = () => {
    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
            {/* Top Filter Bar */}
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-4 border-b border-gray-100 pb-3 gap-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-[500px] md:h-[600px] lg:h-[600px]">
                ...
                {/* Right Panel: Map */}
                <div className="lg:col-span-2 rounded-lg overflow-hidden shadow-inner border border-gray-200 h-full min-h-[400px]">
                    <TerritoryMap
