...
/**
 * AdminPanelPage - Thin Orchestrator
 * Follows SOLID principles: SRP - only handles tab routing and layout
 * All tab-specific logic is delegated to individual tab components
 */
