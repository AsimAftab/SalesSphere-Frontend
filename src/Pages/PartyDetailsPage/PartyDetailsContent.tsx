...
                {/* Row 2: Owner Information Card - UPDATED FOR ADDRESS/DATE POSITION */}
...
                            <UserIcon className="w-4 h-4 text-blue-600" /> {/* Changed icon to UserIcon */}
                        </div>
                        Party Information
                    </h3>
                    
                    {/* Information Grid with re-ordered and adjusted structure */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <span className="font-medium text-gray-500 block">Phone Number</span>
                                <span className="text-gray-800">{party.phone || 'N/A'}</span> 
                            </div>
                        </div>

                        {/* --- Row 2: PAN/VAT Number --- */}
                        <div className="flex items-start gap-2">
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                <span className="font-medium text-gray-500 block">Email Address</span>
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <span className="text-gray-800">{formatJoinDate(party.dateCreated)}</span>
                            </div>
                        </div>
