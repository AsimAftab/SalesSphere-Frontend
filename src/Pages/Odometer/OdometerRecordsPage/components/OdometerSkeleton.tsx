...
const OdometerSkeleton: React.FC<OdometerSkeletonProps> = ({ rows = 10 }) => {
    return (
        <div className="w-full flex flex-col">
            {/* 1. Header Skeleton - Matching MiscWorkSkeletons */}
                    ...
                    <tbody className="divide-y divide-gray-50">
                        {Array(rows).fill(0).map((_, i) => (
                            <tr key={i} className="h-16">
                                ...
                                {/* Date Range */}
                                <td className="px-5 py-3"><Skeleton width={150} height={12} /></td>

                                {/* Total Distance */}
                                <td className="px-5 py-3 text-center"><Skeleton width={80} height={20} borderRadius={4} /></td>

                                {/* View Details */}
                                <td className="px-5 py-3"><Skeleton width={100} height={12} /></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
            ...
            {/* 3. Mobile Card Skeleton - Matching MiscWorkSkeletons */}
